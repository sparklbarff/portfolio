(function() {
  ...
  const PerformanceMonitor = {
    ...
    enablePerformanceMode() {
      ...
      console.log('Enabling performance mode - optimizing glitch animations');
      document.documentElement.classList.add('perf-reduce');
      
      // Reduce glitch animation complexity
      const style = document.createElement('style');
      style.id = 'perf-glitch-optimizations';
      style.textContent = `
        .perf-reduce .tg-letter {
          transition: none !important;
        }
        .perf-reduce #nav-list a {
      ...
      const heavyEffects = document.querySelectorAll('.vhs-dropout, .vhs-head-switch');
      heavyEffects.forEach(el => el.style.display = 'none');
    },
    
    disablePerformanceMode() {
      console.log('Disabling performance mode - restoring full glitch effects');
      document.documentElement.classList.remove('perf-reduce');
      
      // Remove optimization styles
      const optimizationStyle = document.getElementById('perf-glitch-optimizations');
